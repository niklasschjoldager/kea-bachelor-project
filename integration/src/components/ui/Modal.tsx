...
const Modal = ({ children }: Props) => {
  return (
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] max-w-[800px] w-full translate-x-[-50%] translate-y-[-50%] rounded-2 overflow-x-scroll focus:outline-none">
        <Card>
          <div>
            {children}
          </div>
