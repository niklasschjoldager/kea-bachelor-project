        ...
        <Select.Portal>
            <Select.Content
                ...
                <Select.ScrollUpButton
                    className="flex items-center justify-center h-[25px] bg-white cursor-default rotate-180">
                    <Image
                        priority
                        src={ArrowDown}
                        alt="Arrow down"
                ...
                <Select.Viewport>
                    <Select.Group className="px-2 py-3">
                        <Select.Label
                            className="text-label text-dark-gray opacity-60 pb-3 py-0 px-2 last:pb-0">
                            Sites
                        </Select.Label>
                        {sites.map(site => {
                            return (
                        ...
                        <a href="#" className="text-dark-gray p-2 bg-ghost-white rounded-2 flex justify-between">
                            Create a new site
                            <Image
                                priority
                                src={ArrowRight}
