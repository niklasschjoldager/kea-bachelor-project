      ...
      <DropdownMenu.Root>
        ...
        <DropdownMenu.Portal>
          <DropdownMenu.Content
            className="rounded-sm mt-2 border-[1px] border-card-border bg-white shadow-card will-change-[opacity,transform] data-[side=bottom]:animate-slideUpAndFade"
            align="end"
          >
            <DropdownMenu.Label />
            <DropdownMenu.Item
              className="w-40 cursor-pointer p-4 text-dark-gray hover:outline-none"
              onClick={() => signOut()}
            >
              Log out
            </DropdownMenu.Item>
